...
{
    public class TownsendController : Controller
    {
        ...
        public TownsendController(ApplicationDbContext context, IFamilyMemberRepository familyMemberRepository, IPhotoService photoService, IHttpContextAccessor httpContextAccessor)
        {
