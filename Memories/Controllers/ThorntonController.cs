...
{
    public class ThorntonController : Controller
    {
        ...
        public ThorntonController(ApplicationDbContext context, IFamilyMemberRepository familyMemberRepository, IPhotoService photoService, IHttpContextAccessor httpContextAccessor)
        {
